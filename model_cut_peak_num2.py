...
# ## 概率baseline-lamda=0.1-num=30-leaf10-maxdepth-0.4525-去掉peak-num-1.csv

# In[91]:


data_train = pd.read_csv('mydata/data_train.csv')
data_test = pd.read_csv('mydata/data_test.csv')
...
name = 'baseline-lamda=0.1-num=30-leaf10-maxdepth-0.4525-去掉peak-num-1'
